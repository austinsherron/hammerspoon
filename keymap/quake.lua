...
Hotkey.hotkey('F8', { name = 'Quake > Slack', fn = QK:for_binding 'Slack' })
Hotkey.hotkey('F9', { name = 'Quake > WhatsApp', fn = QK:for_binding 'WhatsApp' })
Hotkey.hotkey('F10', { name = 'Quake > TablePlus', fn = QK:for_binding 'TablePlus' })
